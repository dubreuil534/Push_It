...
import com.push_it.isi.push_it.viewChallenge.ChallengePushUpActivity;
...
public class Session extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewsession = inflater.inflate(R.layout.fragment_session, container, false);

        btn = (Button) viewsession.findViewById(R.id.accepterChallenge);

        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), ChallengePushUpActivity.class);
                intent.putExtra("tempsAttribuer2", "100000");
