...
public class ChallengePushUpActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String temps = intent.getStringExtra("tempsAttribuer2");
        String nombre = intent.getStringExtra("nombrePushUp");

        Log.d("debug", "Temps attribuer : " + temps);
